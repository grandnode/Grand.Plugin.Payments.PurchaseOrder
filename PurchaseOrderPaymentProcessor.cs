...
using Grand.Plugin.Payments.PurchaseOrder.Controllers;
using Grand.Services.Configuration;
using Grand.Services.Localization;
using Grand.Services.Orders;
using Grand.Services.Payments;

namespace Grand.Plugin.Payments.PurchaseOrder
{
    /// <summary>
    ...
    public class PurchaseOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Grand.Plugin.Payments.PurchaseOrder.Controllers" }, { "area", null } };
        }
